...
class Statistic4dsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('show', 'backend.statistics4ds.buttons.show')
        ->addColumn('edit', 'backend.statistics4ds.buttons.edit')
        ->addColumn('delete', 'backend.statistics4ds.buttons.delete')
    ...
    {
        return 'statistics4ds_' . date('YmdHis');
    }
}
