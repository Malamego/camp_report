        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{ route('classes.create') }}" data-toggle="tooltip" title="{{trans('main.add')}}  {{trans('main.classes')}}"> <i class="fa fa-plus"></i> </a>
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{ route('classes.edit', [$show->id]) }}" data-toggle="tooltip" title="{{ trans('main.edit') }}  {{ trans('main.job') }}"> <i class="fa fa-edit"></i> </a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        {!! Form::open([ 'method' => 'DELETE', 'route' => ['classes.destroy', $show->id] ]) !!}
                        ...
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{ route('classes.index') }}" data-toggle="tooltip" title="{{trans('main.show-all')}}  {{trans('main.classes')}}"> <i class="fa fa-list"></i> </a>
