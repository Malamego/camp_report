        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{ route('weeks_details.create') }}" data-toggle="tooltip" title="{{trans('main.add')}}  {{trans('main.weeks')}}"> <i class="fa fa-plus"></i> </a>
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{ route('weeks_details.edit', [$show->id]) }}" data-toggle="tooltip" title="{{ trans('main.edit') }}  {{ trans('main.job') }}"> <i class="fa fa-edit"></i> </a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        {!! Form::open([ 'method' => 'DELETE', 'route' => ['weeks_details.destroy', $show->id] ]) !!}
                        ...
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{ route('weeks_details.index') }}" data-toggle="tooltip" title="{{trans('main.show-all')}}  {{trans('main.weeks')}}"> <i class="fa fa-list"></i> </a>
                ...
                <div class="portlet-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <strong>{{trans('main.class')}} : </strong>
                            @if ($show->class_relation)
                                {{ $show->class_relation->name }}
                            @else
                                N/A
                            @endif
                            <br><hr>
