        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{ route('students.create') }}" data-toggle="tooltip" title="{{trans('main.add')}}  {{trans('main.students')}}"> <i class="fa fa-plus"></i> </a>
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{ route('students.edit', [$show->id]) }}" data-toggle="tooltip" title="{{ trans('main.edit') }}  {{ trans('main.job') }}"> <i class="fa fa-edit"></i> </a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        {!! Form::open([ 'method' => 'DELETE', 'route' => ['students.destroy', $show->id] ]) !!}
                        ...
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{ route('students.index') }}" data-toggle="tooltip" title="{{trans('main.show-all')}}  {{trans('main.students')}}"> <i class="fa fa-list"></i> </a>
                ...
                <div class="portlet-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            {{ trans( $show->class_relation->name ) }}
                            <br><hr>
                        </div>
                        <div class="col-md-12">
